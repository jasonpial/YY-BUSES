    ...
    <div style={{ maxWidth: 1100, margin: '0 auto', padding: '12px 0' }}>
      ...
      <Row gutter={[12, 12]} style={{ marginBottom: 40 }}>
        <Col xs={12} sm={12} md={6}>
          <Card hoverable size="small" bordered style={{ borderLeft: '4px solid #1a365d' }}>
            <Statistic 
            ...
            />
            <Text type="secondary" style={{ fontSize: '0.7rem' }}>🟢 Live runs</Text>
          </Card>
        </Col>
        <Col xs={12} sm={12} md={6}>
          <Card hoverable size="small" bordered style={{ borderLeft: '4px solid #7a0016' }}>
            <Statistic 
              ...
              valueStyle={{ fontWeight: 700, fontSize: '1.25rem' }}
            />
            <Text type="secondary" style={{ fontSize: '0.7rem' }}>📦 Warehouse</Text>
          </Card>
        </Col>
        <Col xs={12} sm={12} md={6}>
          <Card hoverable size="small" bordered style={{ borderLeft: '4px solid #52c41a' }}>
            <Statistic 
              ...
              valueStyle={{ fontWeight: 700, fontSize: '1.25rem' }}
            />
            <Text type="secondary" style={{ fontSize: '0.7rem' }}>🚚 Transit</Text>
          </Card>
        </Col>
        <Col xs={12} sm={12} md={6}>
          <Card hoverable size="small" bordered style={{ borderLeft: '4px solid #13c2c2' }}>
            <Statistic 
              ...
              valueStyle={{ fontWeight: 700, fontSize: '1.25rem' }}
            />
            <Text type="secondary" style={{ fontSize: '0.7rem' }}>📅 Roster</Text>
          </Card>
        </Col>
      </Row>
