    ...
    >
      <Layout style={{ minHeight: '100vh' }}>
        ...
        <Header className="app-header" style={{ 
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: 12, cursor: 'pointer' }} onClick={() => navigate('portal')}>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', lineHeight: 1.2 }}>
              <span className="header-title" style={{ color: '#fff', fontWeight: 800, fontSize: '1.2rem', fontFamily: 'Outfit' }}>YY BUSES</span>
              <span className="header-subtitle" style={{ color: '#8c8c8c', fontSize: '0.7rem', textTransform: 'uppercase', letterSpacing: 1 }}>UGANDA LOGISTICS</span>
            </div>
          </div>
        ...
        <Layout>
          ...
          <Content className="workspace-content" style={{ margin: 0, overflowY: 'auto' }}>
